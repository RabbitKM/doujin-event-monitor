...
- 📣 **[社團公告頁](https://www.f-2.com.tw/%e7%a4%be%e5%9c%98%e7%9b%b8%e9%97%9c%e5%85%ac%e5%91%8a/)**：偵測「開放報名」類型的新公告出現（官方標題用詞不固定，如「社團報名開始」「即日起開跑嘍」「即日起開放報名嘍」，只要標題含場次代碼＋「報名」＋開始/開跑/開放等字樣就會判定）
...
**3. 社團公告通知** — 社團相關公告頁出現「開放報名」類型新公告時發送（有聲通知，標題用詞不固定，見上方說明）
...
成功的話：
- 終端機顯示解析到的場次資訊
- 若當天是週一，Discord 頻道會額外收到「📋 每週定期回報」靜音訊息；非週一執行則不會有這則訊息（僅在偵測到狀態變化或新公告時才會發送對應通知）
...
| 活動一覽 | 每週一腳本執行 | 靜音通知 |
| 活動一覽 | 報名時間從「待公佈」變成有日期 | 有聲通知 |
| 社團公告 | 出現「開放報名」類型新公告 | 有聲通知 |

社團公告的判定條件：標題含場次代碼＋「報名」＋開始/開跑/開放等字樣（官方用詞不固定，見開頭說明）。

每週靜音通知裡，報名進行中的場次會依截止日狀態顯示不同樣式：
- **尚未截止**：截止日以 **粗體＋⚠️** 醒目提醒
- **已截止**：截止日恢復一般文字，並標註「（報名已截止）」
